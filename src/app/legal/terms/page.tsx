    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'white' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          <section>
            ...
            <p style={{ color: '#374151', lineHeight: '1.7', margin: '0 0 16px 0' }}>
              If you cancel, you will continue to have access until the end of your current billing period. After that, your account will be restricted, and you will lose access to subscribed features.
            </p>
      ...
      <footer style={{ padding: '48px 0', backgroundColor: colors.primary }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
          <div style={{ display: 'inline-block', backgroundColor: 'rgba(255,255,255,0.95)', padding: '8px 12px', borderRadius: '8px', marginBottom: '16px' }}><Image src="/logo.png" alt="KamperHub" width={140} height={50} /></div>
